...
class Account:
    ...
    # It will create new account based on user input
    def createAccount(self):
        self.AccNo = int(input("Enter the account no : "))  # If user choice is 1
        self.name = input("Enter the account holder name : ")
        self.type = input("Enter your account type [C/S] : ")
        self.deposit = input("Enter The Initial amount: ")
        print("\n\n\nAccount Created")

    # It will show the existing accounts created
